...
! Steps
!
! - finir l'interfacage avec run_dEdd
! - ajouter les variables requises dans le module iceshortwave.F90
! - put on github
!
! - Read file
! - Set station parameters
! - Do loop over stations
! - Call delta-Eddinton routine
! - Diagnose transmittance
! - Write transmittance in output file
! 
!======================================================================================================================
!     
      PROGRAM dEdd_obs
...
!
      ...
      WRITE(*,*) ' Putain ceci est un putain de test '
      ...
      !--------------------------
      yday = 150.              ! CHANGE day of the year
      ...
      tlat = 80. * acos(-1.0) / 180.  ! latitude of temp pts (radians)
      tlon = 0.                       ! longitude of temp pts (radians)
      fsw  = 250.                     ! shortwave input flux
      ...
      vicen(1) = 1.   ! volume per unit area of ice (m) - equal to ice thickness
      vsnon(1) = 0.1  ! volume per unit area of snow (m) - equal to snow depth
      Tsfcn(1) = -10. ! surface temperature (deg C) - equal to air temperature
      apndn(1) = 0.10 ! pond area fraction
